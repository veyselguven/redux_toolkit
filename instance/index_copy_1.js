...
// console.log(songsSlice.actions); //{addSong: ƒ, removeSong: ƒ}
// console.log(songsSlice.actions.addSong("Some Song!!!")); //{type: 'song/addSong', payload: undefined}

store.dispatch(songsSlice.actions.addSong("New SING"));
